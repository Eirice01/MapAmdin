<template>
  <div class="enterArea">
    ...
    <el-dialog
     ...
     :close-on-click-modal='false'>
      ...
      <span slot="footer" class="dialog-footer" v-show="!isView">
        ...
        <el-button type="primary" v-if="title==='添加离开区域报警设置'" @click="confirmAdd">确 定</el-button>
    ...
    <el-dialog
     ...
     :close-on-click-modal='false'>
      <el-input size="small" v-model.trim="fenceQuery.name" style="width: 200px" placeholder="请输入围栏名称"></el-input>
