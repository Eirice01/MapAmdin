<template>
  <div class="vehicle_dialog">
    <div class="head_content">
      <div class="head_left"><span>{{vehicleObj.vehicleNo}}</span></div>
        ...
        <div v-show="dataType === '监控信息'">
          <div style="margin:0 0 0 25px;">
            <div style="width:45%;float:left;height:142px;">
              <span style="font-size:12px;">当前司机：{{vehicleObj.name}}</span>
            ...
            <div style="width:55%;float:right">
              ...
              <div>
                <div class="monitorLeft">状态：</div><div class="monitorRight">{{vehicleObj.activeStatus}}</div>
                <br style="clear:both">
              </div>
              <div>
                <div class="monitorLeft">人数：</div><div class="monitorRight">{{vehicleObj.number}}</div>
                <br style="clear:both">
              </div>
              <div>
                <div class="monitorLeft">速度：</div><div class="monitorRight">{{vehicleObj.CurrentSpeed}}km/h</div>
                <br style="clear:both">
              </div>
              <div>
                <div class="monitorLeft">电量：</div><div class="monitorRight">{{vehicleObj.battery}}</div>
                <br style="clear:both">
              </div>
            </div>
            <div>
              <div class="monitorLeft" style="width:25%">时间：</div><div class="monitorRight" style="width:75%">{{vehicleObj.time}}</div>
              <br style="clear:both">
            </div>
            <div>
              <div class="monitorLeft" style="width:25%">省市：</div><div class="monitorRight" style="width:75%">{{vehicleObj.address}}</div>
              <br style="clear:both">
            </div>
            <div>
              <div class="monitorLeft" style="width:25%">街道：</div><div class="monitorRight" style="width:75%">{{vehicleObj.street}}</div>
              <br style="clear:both">
            </div>
            <br style="clear:both">
          </div>
          ...
          <div v-show="activeName === '车辆信息'" style="margin:10px 0 0 25px;height:170px">
            <div>
              <div class="infoLeft">车牌号：</div><div class="infoRight">{{vehicleObj.vehicleNo}}</div>
              <br style="clear:both">
            </div>
            <div>
              <div class="infoLeft">所属机构：</div><div class="infoRight">{{vehicleObj.deptName}}</div>
              <br style="clear:both">
            </div>
            <div>
              <div class="infoLeft">VIN号：</div><div class="infoRight">{{vehicleObj.vin}}</div>
              <br style="clear:both">
            </div>
            <div>
              <div class="infoLeft">设备ID(主)：</div><div class="infoRight">{{vehicleObj.mainDeviceIds}}</div>
              <br style="clear:both">
            </div>
            <div>
              <div class="infoLeft">设备ID(副)：</div><div class="infoRight">{{vehicleObj.viceDeviceIds}}</div>
              <br style="clear:both">
            </div>
            <div>
              <div class="infoLeft">行业类型：</div><div class="infoRight">{{vehicleObj.type}}</div>
              <br style="clear:both">
            </div>
            <div>
              <div class="infoLeft">车辆品牌：</div><div class="infoRight">{{vehicleObj.vehicleBrand}}</div>
              <br style="clear:both">
            </div>
          </div>
          <div v-show="activeName === '司机信息'" style="margin:10px 0 0 25px;height:170px">
            <div>
              <div class="infoLeft">司机姓名：</div><div class="infoRight">{{vehicleObj.driverName}}</div>
              <br style="clear:both">
            </div>
            <div>
              <div class="infoLeft">所属机构：</div><div class="infoRight">{{vehicleObj.deptName}}</div>
            ...
            <div>
              <div class="infoLeft">工号：</div><div class="infoRight">{{vehicleObj.driverNo}}</div>
              <br style="clear:both">
            </div>
            <div>
              <div class="infoLeft">身份证号：</div><div class="infoRight">{{vehicleObj.idCard}}</div>
              <br style="clear:both">
            </div>
            <div>
              <div class="infoLeft">准驾类型：</div><div class="infoRight">{{vehicleObj.quasiDrivingModel}}</div>
              <br style="clear:both">
            </div>
            <div>
              <div class="infoLeft">驾驶证号：</div><div class="infoRight">{{vehicleObj.drivingLicence}}</div>
              <br style="clear:both">
            </div>
            <div>
              <div class="infoLeft">联系电话：</div><div class="infoRight">{{vehicleObj.mobile}}</div>
              <br style="clear:both">
            </div>
          </div>
        </div>
          ...
          <el-tabs v-model="infoType">
            <el-tab-pane label="电机数据" name="electricData">
              <div v-for="driveData in driveDatalist" :key="driveData.index">
                ...
                <div class="leftStyle">驱动电机状态：</div><div class="rightStyle">{{driveData.status}}</div>
                <div class="leftStyle">驱动电机控制温度：</div><div class="rightStyle">{{driveData.CtrlTemp}}</div>
                <div class="leftStyle">驱动电机转速：</div><div class="rightStyle">{{driveData.DriveSpeed}}</div>
                <div class="leftStyle">驱动电机转矩：</div><div class="rightStyle">{{driveData.DriveTorque}}</div>
                <div class="leftStyle">驱动电机温度：</div><div class="rightStyle">{{driveData.DriveTemp}}</div>
                <div class="leftStyle">电机控制器输入电压：</div><div class="rightStyle">{{driveData.BusVoltage}}</div>
                <div class="leftStyle">电机控制器直流母线电流：</div><div class="rightStyle">{{driveData.BusCurrent}}</div>
              </div>
            </el-tab-pane>
            <el-tab-pane label="储能数据" name="powerData">
              ...
              <div v-for="storageEnergy in bmsData" :key="storageEnergy.index">
                ...
                <div class="leftStyle">子系统电压：</div><div class="rightStyle">{{storageEnergy.vol.Voltage}}</div>
                <div class="leftStyle">子系统电流：</div><div class="rightStyle">{{storageEnergy.vol.Current}}</div>
                ...
                <div>
                  ...
                  <div class="rightStyle" style="height:100px;overflow-y:auto">{{storageEnergy.vol.VolList}}</div>
                  <br style="clear:both">
                </div>
                <div>
                  <div class="leftStyle">探针温度值列表：</div>
                  <div class="rightStyle" style="height:100px;overflow-y:auto">{{storageEnergy.vol.TempList}}</div>
                  <br style="clear:both">
                </div>
                <br style="clear:both">
              </div>
            ...
            <el-tab-pane label="极值数据" name="extremumData">
              ...
              <div class="leftStyle">电池单体电压最高值：</div><div class="rightStyle">{{ExtremeData.MaxVolVal}}</div>
              ...
              <div class="leftStyle">电池单体电压最低值：</div><div class="rightStyle">{{ExtremeData.MinVolIdx}}</div>
              ...
              <div class="leftStyle">最高温度值：</div><div class="rightStyle">{{ExtremeData.MaxTempVal}}</div>
              ...
              <div class="leftStyle">最低温度值：</div><div class="rightStyle">{{ExtremeData.MinTempVal}}</div>
            </el-tab-pane>
          </el-tabs>
        </div>
