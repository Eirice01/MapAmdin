    ...
    <el-dialog
     ...
     :close-on-click-modal='false'>
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" :disabled="isView">
        ...
        <!-- <el-form-item label="分析时间" prop="startEnd">
          <el-date-picker
           v-model="ruleForm.startEnd"
           type="datetimerange"
      ...
      <span slot="footer" class="dialog-footer" v-show="!isView">
        ...
        <el-button type="primary" v-if="title==='添加进入区域报警设置'" @click="confirmAdd" :loading="confirmLoading">确 定</el-button>
    ...
    return {
      ...
      rules: {
        ...
        remindingInterval: [
          ...
          { max: 2, message: '偏移宽度应该在0-60之间', trigger: 'blur' }
        ]
      },
      checked: true,
      isView: false,
